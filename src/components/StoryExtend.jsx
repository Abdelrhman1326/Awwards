        ...
        <div className="h-auto w-dvw flex flex-col">
            <div className="flex justify-center my-20 px-10">
                ...
                <div className="bg-black min-w-full h-[500px] p-25 flex flex-col items-center">
                    ...
                    <h1 className="text-blue-50 text-center special-font uppercase font-zentry text-4xl sm:text-6xl lg:text-7xl xl:text-8xl mb-10">
                        Let's build the <br /> new era of g<b>a</b>ming t<b>o</b>gether.
                    </h1>
                    <button className="font-robert-normal text-xs min-w-[120px] md:text-sm bg-blue-50 text-black/90 px-6 py-3 rounded-full">
                        contact us
                    </button>
                </div>
            </div>
